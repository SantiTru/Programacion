...
// instancia de las clases creadas
      ...
      Canario canario= new Canario("Piquito de oro", 2);
// interacciones
// mamífero
...
// canario
        System.out.println("\n--- Métodos de la clase Canario ---");
        canario.cantar();
        canario.picar();
        System.out.println("Nombre del canario: "+canario.getNombre());
        System.out.println("Edad del canario: "+canario.getEdad());
  }
}
