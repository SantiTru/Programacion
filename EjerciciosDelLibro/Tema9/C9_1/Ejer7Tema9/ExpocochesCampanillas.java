package EjerciciosDelLibro.Tema9.C9_1.Ejer7Tema9;

import java.util.Scanner;

/**
 * @info: Queremos gestionar la venta de entradas (no numeradas) de
...
public class ExpocochesCampanillas {
  public static void main(String[] args) {
    ...
    ZonaCampanillas principal = new ZonaCampanillas(1000);
    ZonaCampanillas gallinero = new ZonaCampanillas(200);
    ZonaCampanillas vip = new ZonaCampanillas(25);
